...
PAGES.settings = () => {
  ...
  if (tab === 'templates') body = `<div class="card card-pad"><p class="muted" style="margin-top:0">Placeholders: <code>{customer} {plate} {vehicle} {vin} {odometer} {number} {amount} {paid} {balance} {validUntil} {items} {status} {item} {date} {time} {address} {method} {receipt} {garage} {garagePhone} {bank}</code></p>
